...
namespace Point1
{
    public class Automove2
    {
        ...
        public Automove2(Vector2 paikka, Random rnd)
        {
            ...
            Console.WriteLine("Automove2 luotu  ");
        }

        public Vector2 Wander(Vector2 paikka, ref int princessSuunta)
        {
            //Console.WriteLine("Wander käynnistetty ");
            //return new Vector2(33, 44);
            this.paikka = paikka;
            vanhaPaikka = paikka;
            princessX = (int)paikka.X;
            princessY = (int)paikka.Y;
            ...
            //princessX = 199;
            //princessY = 99;
            //Vector2 uusi = new Vector2(princessX, princessY);
            //Console.WriteLine("Luotu uusi Vector2  X = " + uusi.X + " Y = " + uusi.Y);
...
public Vector2 CheckRuutu()
        {
            ...
            tarkistus.CheckObstacles(suunta, x, y))
            {
                ...
                //Console.WriteLine("X =  " + princessX + " Y = " + princessY);
